...
Note: _This application is not yet available (probably late December 2022)._

Here is a short description of the different panles
...
* Once you have selected the taxonomy presse **VALIDATE TAXA** and you should see the table of taxons
* To reset the taxonomy press **RESET TAXA** followed by **VALIDATE TAXA**.
* You can save and reload your favorites taxa on the bottom left of the screen
...
This page should be used if you use PR2 to annotated metabarcodes as it contains links to the PR2 repository. 
